...
// MICROPHONE (info https://medium.com/hackernoon/creative-coding-using-the-microphone-to-make-sound-reactive-art-part1-164fd3d972f3)
class Microphone {
	constructor(_fft) {
		...
		// SOUND UTILITIES
		this.mapSound = (_me, _total, _min, _max) => {
		...
		this.getVolume = () => { return this.getVol() }
		//A more accurate way to get overall volume
		this.getRMS = (spectrum) => {
			var rms = 0
